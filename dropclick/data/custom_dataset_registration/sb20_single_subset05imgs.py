...
def dataset_mapping():
    '''
        Use this to configure your dataset (sb20 single).
    ...
    dataset_header = {
        ...
        'dataset_yaml_dir': './datasets/CKA_sugar_beet_2020_subset05imgs/CKA_sugar_beet_2020_subset05imgs.yaml',
        'annotation_file_dir': './datasets/CKA_sugar_beet_2020/CKA_sugar_beet_2020.json',
        'thing_classes': ['plant'],
    }    
