...
Registry for interactive transformer module in MaskFormer.
"""

def build_interactive_transformer(cfg, in_channels, mask_classification=True):
    """
    Build a instance embedding branch from `cfg.MODEL.INS_EMBED_HEAD.NAME`.
    """
    name = cfg.MODEL.MASK_FORMER.INTERACTIVE_TRANSFORMER_NAME
    return INTERACTIVE_TRANSFORMER_REGISTRY.get(name)(cfg, in_channels, True)
