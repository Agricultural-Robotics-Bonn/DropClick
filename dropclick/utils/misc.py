...
def default_argument_parser(epilog=None):
    ...
    parser.add_argument("--eval-skip-ids", type=tuple_ints, default="()", help="image ids to skip for testing")
    parser.add_argument("--visualize-testing", action="store_true", help="visualize testing results")
...
def tuple_ints(strings):
    strings = strings.replace("(", "").replace(")", "")
    return tuple([int(x) for x in strings.split(",")]) if len(strings) else tuple()